...
def cubic_spline(inputs,
    ...
    if inverse:
        ...
        alpha = (-b + torch.sqrt(b.pow(2) - 4*a*c + eps)) / (2*a)
    ...
    if inverse:
        ...
        logabsdet = logabsdet - torch.log(top - bottom) + torch.log(right - left)
    else:
